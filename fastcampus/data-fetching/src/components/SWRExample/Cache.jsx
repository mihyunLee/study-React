...
export default function Cache() {
  // Solved Provider Error: https://github.com/vercel/swr/issues/1949
  const storageProvider = useRef(localStorageProvider());

  return (
    <SWRConfig
      value={{ refreshInterval: 1000, provider: () => storageProvider.current }}
    >
      <Page />
    </SWRConfig>
  );
